...
ASH_PLUG_ROOT="${ASH_PATH_PLUGINS}/bash"
...
if [ ! -f "$ASH_PATH_ROOT/ash_settings.sh" ]; then
    local settings_defalt='
### ---- Settings ---- ###
export HISTLINES=10000
export HISTCONTROL=erasedups:ignoredups:ignorespace
alias edit=vi'
    echo $settings_default > "$ASH_PATH_ROOT/ash_settings.sh"
fi

source "$ASH_PATH_ROOT/ash_settings.sh"

ash_import "common/colors.sh"
ash_import "common/plugins.sh"
ash_import "common/alias.sh"

ash_import "anobash/ash_command.sh"
ash_import "anobash/ash_config.sh"
ash_import "anobash/ash_define.sh"
ash_import "anobash/ash_plugins.sh"
